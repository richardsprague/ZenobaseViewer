...
#import "ZBEventTableViewController.h"

@interface ZBEventTableViewController ()<UITableViewDataSource, UITableViewDelegate>

@end

@implementation ZBEventTableViewController

- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    NSLog(@"ZBEventTableVC ready to switch to next VC");
        ...
        if (indexPath) {
            if ([segue.identifier isEqualToString:@"Show Events"]) {
                if ([segue.destinationViewController respondsToSelector:@selector(didReceiveJSON:)]) {
                    ...
                    NSLog(@"ZBEventTableViewVC will respond later...");
